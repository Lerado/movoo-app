...
export class MovooLoadingService
{
    private _auto$: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(true);
    private _mode$: BehaviorSubject<'determinate' | 'indeterminate' | 'query'> = new BehaviorSubject<'determinate' | 'indeterminate' | 'query'>('query');
     ...
     * Getter for mode
     */
    get mode$(): Observable<'determinate' | 'indeterminate' | 'query'>
    {
     ...
     * @param value
     */
    setMode(value: 'determinate' | 'indeterminate' | 'query'): void
    {
