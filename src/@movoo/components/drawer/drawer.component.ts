...
import { MovooDrawerMode, MovooDrawerPosition } from '@movoo/components/drawer/drawer.types';
import { MovooDrawerService } from '@movoo/components/drawer/drawer.service';
...
export class MovooDrawerComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    @Input() mode: MovooDrawerMode = 'side';
    @Input() name: string = this._movooUtilsService.randomId();
    @Input() opened: boolean = false;
    @Input() position: MovooDrawerPosition = 'left';
    @Input() transparentOverlay: boolean = false;
    @Output() readonly fixedChanged: EventEmitter<boolean> = new EventEmitter<boolean>();
    @Output() readonly modeChanged: EventEmitter<MovooDrawerMode> = new EventEmitter<MovooDrawerMode>();
    @Output() readonly openedChanged: EventEmitter<boolean> = new EventEmitter<boolean>();
    @Output() readonly positionChanged: EventEmitter<MovooDrawerPosition> = new EventEmitter<MovooDrawerPosition>();
    ...
    constructor(
        ...
        private _movooDrawerService: MovooDrawerService,
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'movoo-drawer-animations-enabled'         : this._animationsEnabled,
            'movoo-drawer-fixed'                      : this.fixed,
            'movoo-drawer-hover'                      : this._hovered,
            [`movoo-drawer-mode-${this.mode}`]        : true,
            'movoo-drawer-opened'                     : this.opened,
            [`movoo-drawer-position-${this.position}`]: true
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    {
        // Register the drawer
        this._movooDrawerService.registerComponent(this.name, this);
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._movooDrawerService.deregisterComponent(this.name);
    }
    ...
    private _showOverlay(): void
    {
        ...
        this._overlay.classList.add('movoo-drawer-overlay');

        // Add a class depending on the fixed option
        if ( this.fixed )
        {
            this._overlay.classList.add('movoo-drawer-overlay-fixed');
        }

        // Add a class depending on the transparentOverlay option
        if ( this.transparentOverlay )
        {
            this._overlay.classList.add('movoo-drawer-overlay-transparent');
        }
