...
import { ScrollbarGeometry, ScrollbarPosition } from '@movoo/directives/scrollbar/scrollbar.types';
...
export class MovooScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    ...
    static ngAcceptInputType_movooScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() movooScrollbar: boolean = true;
    @Input() movooScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'movooScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.movooScrollbar = coerceBooleanProperty(changes.movooScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.movooScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'movooScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.movooScrollbarOptions.currentValue);
